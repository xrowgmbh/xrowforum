...
class HTML_BBCodeParser
{
    ...
    */
	...
	$ini = eZINI::instance( "BBCodeParser.ini" );
	$baseoptions = $ini->group( 'HTML_BBCodeParser' );
	    ...
	    @include_once('extension/xrowforum/classes/BBCodeParser/Filter/'.$filter.'.php' );
    ...
    function _buildParsedString()
    {
        ...
        foreach ($this->_tagArray as $tag) {
            ...
            case 1:
                ...
                if( $this->_definedTags[$tag['tag']]['htmlopen'] == "a" OR $this->_definedTags[$tag['tag']]['htmlopen'] == "A")
                {
                    $this->_parsed .= " target='_blank' ";
                }
    ...
    * @author   Stijn de Reede  <sjr@gmx.co.uk>
    */
    static function staticQparse($str)
    {
